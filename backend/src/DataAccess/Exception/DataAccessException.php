...
class DataAccessException extends Exception
{
     ...
     */
    public function __construct(string $message, int $code = 0, \Throwable $previous = null, string $dbType = "SQL")
    {
    ...
    public function isConnectionError(): bool
    {
        ...
        } elseif ($previous instanceof \MongoDB\Driver\Exception\ConnectionTimeoutException ||
